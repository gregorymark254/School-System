...
<body>
<div class="container">
    <form action="Users/MANAGEMENTS/management.php" method="post">
...
if(isset($_POST['submit'])){
    ...
    if($count == 1) {
        ...
        if (!empty($email) && !empty($password) && !empty($department=='Managements')){
            header("LOCATION:Users/MANAGEMENTS/management.php");
        }
